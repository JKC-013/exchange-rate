  ...
  return (
    <div className="space-y-6 animate-fade-in h-[calc(100vh-140px)] flex flex-col uppercase">
      <div className="flex flex-col md:flex-row justify-between items-center shrink-0">
        <div>
          <h1 className="text-5xl font-bold tracking-widest">Data Analyze</h1>
          <p className="text-gray-400 mt-2 text-2xl">Exploratory Data Analysis Notebook</p>
        </div>
      </div>
      ...
      <div className="flex-grow min-h-0 glass-panel overflow-hidden flex flex-col border-4 border-white">
          <div className="bg-black border-b-4 border-white py-3 px-6 shadow-sm shrink-0">
            <h2 className="font-bold text-white tracking-widest text-2xl">DataAnalyze.ipynb</h2>
          </div>
          <iframe 
